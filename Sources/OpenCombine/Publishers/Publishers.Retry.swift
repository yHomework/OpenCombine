...
extension Publisher {
    ...
    /// Attempts to recreate a failed subscription with the upstream publisher using
    /// a specified number of attempts to establish the connection.
    ///
        ...
        where Downstream.Failure == Failure, Downstream.Input == Output
    {
        ...
        func receive(subscription: Subscription) {
            ...
            guard case .ready = state,
                  upstreamSubscription == nil // TODO: Test this
            else {
                lock.unlock()
                subscription.cancel()
                return
        ...
        func receive(_ input: Input) -> Subscribers.Demand {
            ...
            downstreamDemand -= 1 // TODO: Test that this crashes
            lock.unlock()
